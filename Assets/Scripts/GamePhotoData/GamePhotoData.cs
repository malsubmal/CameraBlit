...
public struct CameraState : IEquatable<CameraState>, IDefaultable<CameraState>
{
    ...
    public float ComputeVariance(CameraState other)
    {
        return (_position - other._position).sqrMagnitude
               ...
               + Mathf.Pow((_zoomValue - other._zoomValue),2); //square to give equal importance among  three factors
    }
    public bool Equals(CameraState other)
    {
        return _position.Equals(other._position) && _rotation.Equals(other._rotation) && _zoomValue.Equals(other._zoomValue);
    }
...
public static class PhotoComparer
{
    ...
    public static bool IsSimilarFrame(this GamePhotoData thisPhoto, GamePhotoData comparePhoto, float toleranceRange)
    {
